    ...
    <TerraPage maxWidth={1200}>
      ...
      <div className="card">
        <div className="row">
          ...
          <button className="btn" onClick={() => r.push("/dev/notifications")} style={{ background: "var(--brandSoft)", borderColor: "var(--brand2)", color: "var(--brand)", fontWeight: 800 }}>Notifikasi</button>
