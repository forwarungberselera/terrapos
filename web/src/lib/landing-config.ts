  ...
  pricing: [
    {
      ...
      price: "Gratis",
      period: "",
      description: "Untuk outlet baru yang mau coba",
      features: ["1 outlet", "POS dasar", "Order & pembayaran", "Browser print", "Laporan harian"],
      highlighted: false,
    ...
    },
    {
      ...
      price: "Rp149k",
      period: "/bulan",
      description: "Untuk outlet yang butuh fitur lengkap",
      features: ["Semua fitur Starter", "RawBT & Bluetooth print", "Dashboard premium", "QR meja", "Export Excel", "Shift management"],
      highlighted: true,
      ctaText: "Pilih Pro",
    },
    {
      ...
      price: "Custom",
      period: "",
      description: "Untuk multi outlet & franchise",
      features: ["Semua fitur Pro", "Multi tenant/cabang", "Kustomisasi branding", "Integrasi lanjutan", "Support prioritas", "SLA guarantee"],
      highlighted: false,
